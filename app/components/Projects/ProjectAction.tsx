...
const Project = {
     ...
     */
    getAllProjects: function (order: "ASC" | "DESC"): Array<IProject> {
     ...
     */
    getHackathonProjects: function (order: "ASC" | "DESC"): Array<IProject> {
     ...
     */
    getAcademicProjects: function (order: "ASC" | "DESC"): Array<IProject> {
