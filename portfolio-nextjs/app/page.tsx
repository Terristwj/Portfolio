        ...
        <div className="divide-y divide-gray-700 dark:divide-gray-100">
            ...
            <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
                <div className=" flex flex-col items-center pt-8 noSelect">
                    ...
                    />
                    <h3 className="text-teal-600 dark:text-teal-400 pt-4 pb-2 text-2xl font-bold leading-8 tracking-tight">
                        Terris Tan
                    </h3>
                    <p className="text-black dark:text-white text-center font-semibold fira-code">
                        <Typewriter
                            words={[
                                "Software-Engineer",
                ...
                <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2 montserrat font-medium">
                    <p>
                        Hey everyone my name is Terris, I am 23 years old and i
                        am a Full Stack developer based in Singapore.
                    </p>
                    <p>
                        I am currently a student in Singapore Management
                        University and I love building Full Stack applications
                        during my spare time. In fact, this portfolio was an
                        experiment to try out Next.js with TailwindCSS.
                    </p>
                    <p>
                        Building applications, such as eCommerce, micro-site, or
                        SaaS, is my ultimate combination of creative expression,
                        technical expertise, and self-improvement. I am thrilled
                        to continue this journey, honing my skills, and
